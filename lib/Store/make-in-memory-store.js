...
import DatabaseLib from '@Dev-FelixOfc/databaselib';
...
export const makeInMemoryStore = (config) => {
    ...
    const chats = new DatabaseLib(chatKey, c => c.id);
    const messages = {};
    const contacts = {};
    const groupMetadata = {};
    const presences = {};
    ...
    const labelAssociations = new DatabaseLib(labelAssociationKey, labelAssociationKey.key);
